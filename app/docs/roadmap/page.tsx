    ...
    return (
        <>
            ...
            <div className="space-y-12 my-16">
                ...
                <div className="relative pl-8 border-l border-red-500/30">
                    ...
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <h3 className="!my-0 text-white font-bold">Foundation & Ecology</h3>
                    </div>
                ...
                <div className="relative pl-8 border-l border-white/10">
                    <div className="absolute -left-1.5 top-0 w-3 h-3 bg-zinc-800 rounded-full" />
                    <div className="flex items-center gap-3 mb-2">
                        <span className="text-xs font-bold text-zinc-500 uppercase tracking-widest bg-white/5 px-2 py-0.5 rounded">Q3 2026</span>
                        <h3 className="!my-0 text-white font-bold">Distributed Signal Mesh</h3>
                    </div>
                    <p className="text-zinc-400 text-sm mb-4">
                        Introduction of multi-agent coordination. One agent plans, while specialized sub-agents execute tasks in parallel.
                    </p>
                    <div className="p-4 bg-zinc-900 rounded-xl border border-white/5 text-xs text-zinc-500 italic">
                ...
                <div className="relative pl-8 border-l border-white/10">
                    <div className="absolute -left-1.5 top-0 w-3 h-3 bg-zinc-800 rounded-full" />
                    <div className="flex items-center gap-3 mb-2">
                        <span className="text-xs font-bold text-zinc-500 uppercase tracking-widest bg-white/5 px-2 py-0.5 rounded">Q4 2026</span>
                        <h3 className="!my-0 text-white font-bold">Self-Correcting Memory</h3>
                    </div>
                    <p className="text-zinc-400 text-sm mb-4">
            ...
            <div className="not-prose p-1 bg-gradient-to-br from-red-500/20 to-purple-500/20 rounded-2xl">
                <div className="bg-black p-8 rounded-[calc(1rem-1px)] text-center">
                    <h3 className="text-white font-bold mb-4">Want to influence the roadmap?</h3>
