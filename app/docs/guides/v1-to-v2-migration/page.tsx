...
export default function MigrationPage() {
        ...
        <>
            ...
            <div className="not-prose bg-yellow-500/10 border border-yellow-500/20 rounded-xl p-6 my-8">
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        <h3 className="text-lg font-bold text-white mb-2">Breaking Changes Ahead</h3>
            ...
            <div className="not-prose space-y-4 my-6">
                <div className="p-4 bg-red-500/10 border border-red-500/20 rounded-lg">
                    ...
                    <p className="text-sm text-zinc-400">v1 used YAML, v2 requires strict JSON. No more indentation errors!</p>
                </div>
                ...
                <div className="p-4 bg-red-500/10 border border-red-500/20 rounded-lg">
                    ...
                    <p className="text-sm text-zinc-400">New skill registry. Old plugins need updates. Browse <Link href="/skills" className="text-red-400 hover:text-red-300">v2-compatible plugins</Link>.</p>
                </div>
                ...
                <div className="p-4 bg-red-500/10 border border-red-500/20 rounded-lg">
                    ...
                    <p className="text-sm text-zinc-400">v2 has stricter dependency requirements. See our <Link href="/docs/getting-started/docker-setup" className="text-red-400 hover:text-red-300">Docker setup guide</Link>.</p>
                </div>
            </div>
            ...
            <div className="not-prose bg-zinc-900 border border-white/10 rounded-lg p-4 my-4">
                <pre className="text-sm text-zinc-300"><code>cp config.yaml config.yaml.backup</code></pre>
            </div>
            ...
            <div className="not-prose grid md:grid-cols-2 gap-4 my-6">
                <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-4">
                    <div className="flex items-center gap-2 mb-2">
                        <span className="text-sm font-bold text-white">❌ v1 (YAML)</span>
                    </div>
                    <pre className="text-sm text-zinc-300 overflow-x-auto"><code>{`llm:
  provider: openai
  api_key: sk-...
  model: gpt-4`}</code></pre>
                ...
                <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-4">
                    <div className="flex items-center gap-2 mb-2">
                        <span className="text-sm font-bold text-white">✅ v2 (JSON)</span>
                    </div>
  ...
  "skills": [
    ...
    "crypto-tracker"    // v2 compatible
            ...
            <div className="not-prose space-y-3 my-6">
                <details className="p-4 bg-zinc-900 border border-white/10 rounded-lg">
                    <summary className="text-white font-semibold cursor-pointer">JSON Parse Error</summary>
                ...
                <details className="p-4 bg-zinc-900 border border-white/10 rounded-lg">
                    <summary className="text-white font-semibold cursor-pointer">Plugin Not Found</summary>
                    <p className="text-sm text-zinc-400 mt-2">
                ...
                <details className="p-4 bg-zinc-900 border border-white/10 rounded-lg">
                    <summary className="text-white font-semibold cursor-pointer">Connection Refused</summary>
                    <p className="text-sm text-zinc-400 mt-2">
            ...
            <div className="not-prose bg-zinc-900 border border-white/10 rounded-lg p-4 my-4">
                <pre className="text-sm text-zinc-300"><code>{`# Restore backup
...
npm install -g openclaw@1.x`}</code></pre>
            ...
            <div className="not-prose grid md:grid-cols-3 gap-4 my-8">
                <Link href="/tools/config" className="p-4 bg-blue-500/10 border border-blue-500/20 rounded-lg hover:bg-blue-500/20 transition-colors">
                    ...
                    <p className="text-sm text-zinc-400">Auto-convert v1 to v2</p>
                </Link>
                <Link href="/tools/doctor" className="p-4 bg-green-500/10 border border-green-500/20 rounded-lg hover:bg-green-500/20 transition-colors">
                    <h3 className="text-white font-semibold mb-2">Local Doctor</h3>
                    <p className="text-sm text-zinc-400">Validate your config</p>
                </Link>
                <Link href="/skills" className="p-4 bg-orange-500/10 border border-orange-500/20 rounded-lg hover:bg-orange-500/20 transition-colors">
                    <h3 className="text-white font-semibold mb-2">Skill Registry</h3>
                    <p className="text-sm text-zinc-400">Find v2 plugins</p>
                </Link>
            </div>
