        ...
        <>
            ...
            <div className="not-prose grid md:grid-cols-2 gap-4 my-8">
                <div className="p-5 bg-card/50 border border-border rounded-xl">
                    <div className="flex items-center gap-2 mb-3">
                        ...
                        <span className="text-sm font-bold text-muted-foreground">Without ClawKit</span>
                    </div>
                    <ul className="space-y-2 text-sm text-muted-foreground">
                        ...
                        <li className="pt-2 border-t border-border text-foreground font-bold">Total: 1-2 hours</li>
                    </ul>
                </div>
            ...
            <div className="not-prose space-y-3 my-6">
                <div className="flex items-start gap-4 p-4 bg-card border border-border rounded-xl">
                    ...
                    <div>
                        <h4 className="text-foreground font-semibold">Node.js (version 18 or higher)</h4>
                        ...
                        <code className="block mt-2 text-sm bg-card px-3 py-2 rounded text-foreground/80">node --version</code>
                        <p className="text-xs text-muted-foreground mt-2">
                            If you see <code className="text-muted-foreground">v18.x.x</code> or higher, you are good.
                ...
                <div className="flex items-start gap-4 p-4 bg-card border border-border rounded-xl">
                    ...
                    <div>
                        <h4 className="text-foreground font-semibold">An API Key (for the AI model)</h4>
                        <p className="text-sm text-muted-foreground mt-1">
                        ...
                        <div className="grid grid-cols-3 gap-2 mt-3">
                            <div className="text-center p-2 bg-card rounded-lg">
                                ...
                                <div className="text-[10px] text-muted-foreground mt-1">Cheapest option</div>
                            </div>
                            <div className="text-center p-2 bg-card rounded-lg">
                                <div className="text-xs font-bold text-foreground/80">OpenAI</div>
                                <div className="text-[10px] text-muted-foreground mt-1">Most popular</div>
                            </div>
                            <div className="text-center p-2 bg-card rounded-lg">
                                <div className="text-xs font-bold text-orange-400">Claude</div>
                                <div className="text-[10px] text-muted-foreground mt-1">Best reasoning</div>
                            </div>
                        </div>
                ...
                <div className="flex items-start gap-4 p-4 bg-card border border-border rounded-xl">
                    ...
                    <div>
                        <h4 className="text-foreground font-semibold">A Terminal (Command Line)</h4>
                        <p className="text-sm text-muted-foreground mt-1">
                            You will need to type a few commands. Don&apos;t worry, we will tell you exactly what to type.
                        </p>
                        <div className="mt-2 text-xs text-muted-foreground space-y-1">
                            <p><strong>Windows:</strong> Press <code className="text-muted-foreground">Win + R</code>, type <code className="text-muted-foreground">cmd</code>, press Enter</p>
                            <p><strong>Mac:</strong> Press <code className="text-muted-foreground">Cmd + Space</code>, type <code className="text-muted-foreground">Terminal</code>, press Enter</p>
                            <p><strong>Linux:</strong> Press <code className="text-muted-foreground">Ctrl + Alt + T</code></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="not-prose bg-blue-500/10 border border-blue-500/20 rounded-xl p-6 my-6">
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        <h3 className="text-lg font-bold text-foreground mb-2">Open the Config Wizard</h3>
                        <ol className="text-sm text-foreground/80 space-y-2 mb-4">
                            ...
                            <li>5. Save the <code className="bg-card px-1 rounded">clawhub.json</code> file to a folder you will remember</li>
                        </ol>
                        <Link
                            href="/tools/config"
            ...
            <div className="not-prose bg-card border border-border rounded-lg p-4 my-4">
                <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-xs text-muted-foreground uppercase tracking-wider">Copy and paste into your terminal</span>
                </div>
                <pre className="text-sm text-foreground/80"><code>npm install -g openclaw</code></pre>
            </div>
            ...
            <details className="my-4">
                ...
                <div className="mt-2 pl-4 border-l-2 border-border text-sm text-muted-foreground">
                ...
                <div className="flex items-start gap-2">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-muted-foreground mt-1">
                            <strong>Mac/Linux:</strong> Add <code className="text-foreground/80">sudo</code> before the command: <code className="text-foreground/80">sudo npm install -g openclaw</code>
                        </p>
                        <p className="text-xs text-muted-foreground mt-1">
            ...
            <div className="not-prose bg-card border border-border rounded-lg p-4 my-4">
                ...
                <pre className="text-sm text-foreground/80"><code>{`cd /path/to/your/folder
openclaw start --config clawhub.json`}</code></pre>
            ...
            <details className="my-4">
                ...
                <div className="mt-2 pl-4 border-l-2 border-border text-sm text-muted-foreground space-y-2">
                    <p><strong>Example (Mac):</strong> If you saved it to Downloads: <code className="text-foreground/80">cd ~/Downloads</code></p>
                    <p><strong>Example (Windows):</strong> If you saved it to Desktop: <code className="text-foreground/80">cd C:\Users\YourName\Desktop</code></p>
                    <p><strong>Tip:</strong> On Mac, you can type <code className="text-foreground/80">cd </code> (with a space) then drag the folder into the terminal window.</p>
                </div>
            </details>

            <p>If everything works, you will see:</p>

            <div className="not-prose bg-card border border-green-500/20 rounded-lg p-4 my-4">
...
Your AI agent is running! Open http://127.0.0.1:3000 in your browser.`}</code></pre>
            ...
            <div className="not-prose bg-green-500/10 border border-green-500/20 rounded-xl p-6 my-6">
                <h3 className="text-lg font-bold text-foreground mb-3">Auto-Diagnose with Local Doctor</h3>
            ...
            <div className="not-prose space-y-2 my-4">
                <Link href="/docs/troubleshooting/connection-errors" className="flex items-center gap-3 p-3 bg-card border border-border rounded-lg hover:border-blue-500/30 transition-colors group">
                    <span className="text-sm text-muted-foreground group-hover:text-foreground">See &quot;ECONNREFUSED&quot; or &quot;Connection Refused&quot;?</span>
                    <ArrowRight className="w-4 h-4 text-muted-foreground/70 group-hover:text-blue-400 ml-auto shrink-0" />
                </Link>
                <Link href="/docs/troubleshooting/json-parse-errors" className="flex items-center gap-3 p-3 bg-card border border-border rounded-lg hover:border-blue-500/30 transition-colors group">
                    <span className="text-sm text-muted-foreground group-hover:text-foreground">See &quot;JSON Parse Error&quot; or &quot;Unexpected token&quot;?</span>
                    <ArrowRight className="w-4 h-4 text-muted-foreground/70 group-hover:text-blue-400 ml-auto shrink-0" />
                </Link>
                <Link href="/docs/troubleshooting/windows-issues" className="flex items-center gap-3 p-3 bg-card border border-border rounded-lg hover:border-blue-500/30 transition-colors group">
                    <span className="text-sm text-muted-foreground group-hover:text-foreground">Using Windows and something looks wrong?</span>
                    <ArrowRight className="w-4 h-4 text-muted-foreground/70 group-hover:text-blue-400 ml-auto shrink-0" />
                </Link>
                <Link href="/docs/troubleshooting/api-key-problems" className="flex items-center gap-3 p-3 bg-card border border-border rounded-lg hover:border-blue-500/30 transition-colors group">
                    <span className="text-sm text-muted-foreground group-hover:text-foreground">See &quot;Invalid API Key&quot; or &quot;401 Unauthorized&quot;?</span>
                    <ArrowRight className="w-4 h-4 text-muted-foreground/70 group-hover:text-blue-400 ml-auto shrink-0" />
                </Link>
            </div>
            ...
            <div className="not-prose grid md:grid-cols-3 gap-4 my-8">
                <Link href="/docs/getting-started/first-config" className="p-4 bg-blue-500/10 border border-blue-500/20 rounded-xl hover:bg-blue-500/20 transition-colors group">
                    <h3 className="text-foreground font-semibold mb-2 flex items-center justify-between">
                        Customize Config
                        <ArrowRight className="w-4 h-4 opacity-0 group-hover:opacity-100 text-blue-400" />
                    </h3>
                    <p className="text-sm text-muted-foreground">Fine-tune your agent settings</p>
                </Link>
                <Link href="/skills" className="p-4 bg-orange-500/10 border border-orange-500/20 rounded-xl hover:bg-orange-500/20 transition-colors group">
                    ...
                    <p className="text-sm text-muted-foreground">Browser control, memory, and more</p>
                </Link>
                <Link href="/docs/guides/cost-optimization" className="p-4 bg-green-500/10 border border-green-500/20 rounded-xl hover:bg-green-500/20 transition-colors group">
                    ...
                    <p className="text-sm text-muted-foreground">Cut API spending by up to 90%</p>
                </Link>
            </div>
