...
export default function TroubleshootingPage() {
    return (
        <div className="container mx-auto px-4 py-16 max-w-4xl">
            ...
            <Card className="bg-card border-green-500/30 mb-16 relative overflow-hidden">
            ...
            <div className="space-y-8">
                <h2 className="text-2xl font-bold text-foreground flex items-center gap-2 border-b border-border pb-4">
                ...
                <Accordion type="single" collapsible className="w-full">
                    ...
                    <AccordionItem value="item-1" className="border-border">
                        <AccordionTrigger className="text-lg text-foreground font-mono hover:text-red-400 text-left">
                        ...
                        <AccordionContent className="text-muted-foreground space-y-4 pt-4">
                            ...
                            <div className="bg-card p-4 rounded-lg border border-red-900/50">
                                <p className="text-green-400 font-mono text-sm">
                                    <span className="text-muted-foreground"># Solution: Change host to 127.0.0.1</span><br />
                                    HOST=127.0.0.1
                                </p>
                            </div>
                            <p>
            ...
            <div className="mt-12 p-6 bg-blue-900/20 border border-blue-500/20 rounded-xl text-center">
                <h3 className="text-foreground font-bold mb-2">Still stuck?</h3>
