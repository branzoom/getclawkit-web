...
export default async function SkillsPage() {
    ...
    const skills = skillsIndex.map((s: { id: string; name: string; shortDesc: string; tags: string[]; author: string; stars: number; sourceRepo: string | null }) => ({
        ...
        tags: Array.isArray(s.tags) ? s.tags.filter((t: string): t is string => typeof t === 'string') : [],
        author: s.author || '',
        stars: s.stars || 0,
            ...
            <div className="mt-24 border-t border-border pt-16">
                ...
                <div className="grid md:grid-cols-2 gap-8 text-sm">
                    <div className="space-y-2">
                        <h3 className="font-bold text-foreground text-base">How do I install these skills?</h3>
                    ...
                    <div className="space-y-2">
                        <h3 className="font-bold text-foreground text-base">Are these safe to use?</h3>
                        <p className="text-muted-foreground leading-relaxed">
                    ...
                    <div className="space-y-2">
                        <h3 className="font-bold text-foreground text-base">Can I submit my own skill?</h3>
                        <p className="text-muted-foreground leading-relaxed">
